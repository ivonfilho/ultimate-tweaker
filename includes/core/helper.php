...
if ( ! class_exists( 'UT_Core_Helper' ) ) {
	class UT_Core_Helper {
        ...
        /** @var UT_Core_Updater_Loader  */
        private $updater;

        /**
         * @return UT_Core_Updater_Loader
         */
...
//            register_activation_hook( $__FILE__, array( $this, 'activate' ) );
            ...
            $this->updater = new UT_Core_Updater_Loader($this);
...
//			return $css;
        ...
        public function getOptions($name = null) {
            ...
            return new UT_Core_OptionCollection(get_option($name));
        }

        public function createMenu($addMenuPriority = 100) {
		    require_once 'admin_menu.php';

		    return new UT_Core_AdminMenu($this, $addMenuPriority);
        }
