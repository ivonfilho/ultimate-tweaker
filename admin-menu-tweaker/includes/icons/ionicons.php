...
if (!function_exists('getIcons_ionicons')) {
    function getIcons_ionicons() {
        return array(
            "alert"                          => "f101",
            "alert-circled"                  => "f100",
            "android-add"                    => "f2c7",
            ...
            "ios-informatempty"              => "f44b",
            "ios-informatoutline"            => "f44c",
