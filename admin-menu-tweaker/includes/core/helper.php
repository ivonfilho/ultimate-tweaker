...
if ( ! class_exists( 'AMT_Core_Helper' ) ) {
	class AMT_Core_Helper {
        ...
        /** @var AMT_Core_Updater_Loader  */
        private $updater;

        /**
         * @return AMT_Core_Updater_Loader
         */
		...
		function __construct( $__FILE__, $name, $slug, $version, $isDebug ) {
            ...
            $this->updater = new AMT_Core_Updater_Loader($this);
		...
		function enqueueScriptsOn() {
			...
			if ( count( $this->_enqueueLocalizeScriptQueue ) ) {
			    $q = $this->_enqueueLocalizeScriptQueue;
...
//			return $css;
        ...
        public function getOptions($name = null) {
            ...
            return new AMT_Core_OptionCollection(get_option($name));
        }

        public function createMenu($addMenuPriority = 100) {
		    require_once 'admin_menu.php';

		    return new AMT_Core_AdminMenu($this, $addMenuPriority);
        }
